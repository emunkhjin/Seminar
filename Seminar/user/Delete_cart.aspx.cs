...
namespace Seminar.user
{
    public partial class Delete_cart : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Response.Cookies["aa"].Value = Response.Cookies["aa"].Value +"|"+ product_name.ToString() + "," + product_desc.ToString() + "," + product_price.ToString() + "," + product_qty.ToString() + "," + product_images.ToString();
                Response.Cookies["aa"].Expires = DateTime.Now.AddYears(30);
            }
