<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="dashboard.aspx.cs" Inherits="Seminar.admin.dashboard" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="alert alert-success" role="alert">
  Админ дашбоард.  Зүүн хэсэгт байрлах цэснээс ашиглана уу . 
</div>
    <!--Grid row-->
<div class="row">
